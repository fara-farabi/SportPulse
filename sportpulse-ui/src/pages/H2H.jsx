...
export default function H2H() {
  ...
  const search = async () => {
    ...
    try {
      ...
      else setError('No matches found. Try: Arsenal, Chelsea, Liverpool, Manchester City');
        ...
        <>
          ...
          <div className="grid-2" style={{ marginBottom: 20 }}>
            <div className="stat-box">
              ...
              <div className="label">{result.team1} Goals</div>
            </div>
            <div className="stat-box">
              <div className="num">{result.summary.team2Goals}</div>
              <div className="label">{result.team2} Goals</div>
            </div>
          </div>
